...
var openai = new OpenAI({
    apiKey: process.env.OPENAI_API_KEY, // Store your API key in env variable
});
var transcription = await openai.audio.transcriptions.create({
    file: fs.createReadStream("scripts/Lets Talk About Education [TubeRipper.com].mp3"),
    model: "whisper-1", // Use whisper-1 as of now, "gpt-4o-transcribe" is not available for transcription
});
